...
@Component({
  selector: 'app-eightitems',
  templateUrl: './eightitems.component.html',
  styles: [`
  .btnrptcontainer{
    display:grid;
...
export class EightitemsComponent implements OnInit {

  id:any;
  displayedColumns: string[] = ['Sr.No','Reach','Frequency','Freqreach','Item','Incr1','Incr2','Incr3','Incr4','Incr5','Incr6','Incr7','Incr8'];
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.FiveItem = "/admin/project/cell/eightitems/"+this.id;
    ...
    this.dataSource = new MatTableDataSource(this.itemlist[7]);
...
export interface eightitem{
  ...
  incremental_reach7 : any;
  incremental_reach8 : any;
}
