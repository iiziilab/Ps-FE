...
@Component({
  selector: 'app-fiveitems',
  templateUrl: './fiveitems.component.html',
  styles: [`
  .btnrptcontainer{
    display:grid;
  }
...
export class FiveitemsComponent implements OnInit {

  id:any;
  displayedColumns: string[] = ['Sr.No','Reach','Frequency','Freqreach','Item1','Item2','Item3','Item4','Item5','Incr1','Incr2','Incr3','Incr4','Incr5'];
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.dataSource = new MatTableDataSource(this.itemlist[4]);
