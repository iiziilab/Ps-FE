...
@Component({
  selector: 'app-fouritems',
  templateUrl: './fouritems.component.html',
  styles: [`
  .btnrptcontainer{
    display:grid;
  }
...
export class FouritemsComponent implements OnInit {
  ...
  id:any;
  displayedColumns: string[] = ['Sr.No','Reach','Frequency','Freqreach','Item1','Item2','Item3','Item4','Incr_reach1','Incr_reach2','Incr_reach3','Incr_reach4'];
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.dataSource = new MatTableDataSource(this.itemlist[3]);
