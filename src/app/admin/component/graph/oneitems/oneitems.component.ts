...
@Component({
  selector: 'app-oneitems',
  templateUrl: './oneitems.component.html',
  styles: [`
  .btnrptcontainer{
    display:grid;
...
export class OneitemsComponent implements OnInit {

  id:any;
  displayedColumns: string[] = ['Sr.No','Reach','Frequency','Item'];
