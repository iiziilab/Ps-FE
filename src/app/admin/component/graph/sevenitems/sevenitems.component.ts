...
@Component({
  selector: 'app-sevenitems',
  templateUrl: './sevenitems.component.html',
  styles: [`
  .btnrptcontainer{
    display:grid;
...
export class SevenitemsComponent implements OnInit {

  id:any;
  displayedColumns: string[] = ['Sr.No','Reach','Frequency','Freqreach','Item','Incr1','Incr2','Incr3','Incr4','Incr5','Incr6','Incr7'];
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.FiveItem = "/admin/project/cell/sevenitems/"+this.id;
    ...
    this.dataSource = new MatTableDataSource(this.itemlist[6]);
