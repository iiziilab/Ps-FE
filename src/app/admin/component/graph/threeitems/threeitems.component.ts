...
import { twoitem, TwoitemsComponent } from '../twoitems/twoitems.component';
import * as Excel from 'exceljs';
import { Workbook } from 'exceljs';
import * as fs from 'file-saver';

@Component({
  selector: 'app-threeitems',
...
export class ThreeitemsComponent implements OnInit {

  id:any;
  displayedColumns: string[] = ['Sr.No','Reach','Frequency','Freqreach','Item1','Item2','Item3','Incr_reach1','Incr_reach2','Incr_reach3'];
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.itemlist = JSON.parse(localStorage.report)
    this.dataSource = new MatTableDataSource(this.itemlist[2]);
